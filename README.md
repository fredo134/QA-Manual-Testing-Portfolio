...
Welcome! This repository contains my hands-on Quality Assurance (QA) projects, featuring end-to-end testing methodologies across **Manual Testing**, **API Testing**, and **UI Test Automation**.
...
- **Defect Management & Management:** Jira, GitHub Issues, Severity/Priority Categorization
...
### 1. 🚀 [ReqRes REST API Testing Suite](./API_testing/)
...
* 🐛 **[GitHub Defect Tracker](https://github.com/fredo134/QA-Manual-Testing-Portfolio/issues)**### 2. 📋 [SauceDemo Manual Testing Project](./Manual_testing/)
